...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full overflow-hidden bg-card border border-transparent dark:border-white/[0.2] group-hover:border-primary/20 relative z-20 flex flex-col cursor-pointer transition-all duration-300",
        className
      )}
    >
      {children}
